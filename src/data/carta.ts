...
export const carta_bar: ICategoria[] = [
  {
    ...
    productos: [
      ...
      {
        nombre: "NACHOS_HEAVENS",
        descripcion: "NACHOS_HEAVENS_DESC",
        precio: 12,
      },
    ],
  },
  ...
  },
  {
    ...
    productos: [
      ...
      {
        nombre: "DE_JAMON_IBERICO",
        precio: 7.5,
      },
      {
        nombre: "DE_JAMON_SERRANO_QUESO_CURADO",
        precio: 5,
      },
      {
  ...
  },
  {
    ...
    productos: [
      ...
      {
        nombre: "GOFRE_NOCILLA",
        precio: 4,
      },
      {
        nombre: "GOFRE_NOCILLA_NATA",
        precio: 4.5,
      },
      {
        nombre: "GOFRE_BAYLEYS",
        precio: 5,
      },
    ],
  },
